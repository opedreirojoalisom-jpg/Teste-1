...
-- Fixed version with proper aimbot implementation
...
iconButton.Parent = lokosHubPanel
...
panelWindow.Position = UDim2.new(0, 10, 0, 80)
...
iconButton.MouseButton1Click:Connect(function()
    panelWindow.Visible = not panelWindow.Visible
end)
